...
year_frac_est_long <- c(yearFraction('2023/9/1', '2024/3/1'),
                   yearFraction('2024/9/1', '2025/3/1'),
                   yearFraction('2025/9/1', '2026/3/1'),
                   yearFraction('2026/9/1', '2027/3/1'),
                   yearFraction('2027/9/1', '2028/3/1'))


year_frac_est_short <- c(yearFraction('2023/9/1', '2024/1/27'),
                        yearFraction('2024/9/1', '2025/1/27'),
                        yearFraction('2025/9/1', '2026/1/27'),
                        yearFraction('2026/9/1', '2027/1/27'),
                        yearFraction('2027/9/1', '2028/1/27'))
...
year=c(1,2,3,4)
plot(year,fwd_matrix[1,],type="o", main="Forward Curve", col="black", xlab="Year", ylab="Forward Rate")
colour = c(1:10)
for (i in c(2:10)){
